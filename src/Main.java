...
public class Main {
    public static void main(String[] args){
        ...
        int opcion= 0 ;
        float ingreso = 0, saldoActual = saldo_inicial + ingreso,retiro;
       while (opcion != 3){
        ...
        switch (opcion) {
            case 1:
                ingreso = Integer.parseInt(JOptionPane.showInputDialog("Dijite la cantidad que desea ingresar en la cuenta :"));
                saldoActual = saldo_inicial + ingreso;
                JOptionPane.showMessageDialog(null, "el dinero actual de su cuenta es: " + saldoActual);
                break;
            case 2:
                retiro = Float.parseFloat(JOptionPane.showInputDialog("Dijite la cantidad que desea retirar: "));
            ...
            case 3:
                break;
            default:
                JOptionPane.showMessageDialog(null, "ese numero no existe papi lea bien solo puede dijitar el 1 2 3 ");
                break;
        }
        }
    }
